...
export const AIWizardPanel = () => {
  const { isOpen, currentStep, error, closeWizard, goToStep } = useAIWizardStore()

  return (
    <div
      className={cn(
        'h-full w-80 flex-shrink-0 border-l border-gray-200 bg-gray-50 transition-all duration-300 ease-in-out overflow-hidden',
